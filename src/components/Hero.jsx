  ...
  return (
    <section id="home" ref={heroRef} className="relative h-screen w-full overflow-hidden flex items-center">
      <div className="absolute inset-0 w-full h-full">
        <img ref={bgRef} src="/images/hero-bg.png" alt="TAKKERU Japanese food cart franchise" className="absolute inset-0 w-full h-full object-cover scale-110" />
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="max-w-4xl text-left">
          ...
          <div className="hero-text flex flex-col sm:flex-row gap-4 sm:gap-6">
            <a href="https://tally.so/r/XxaDyj" target="_blank" rel="noopener noreferrer" className="px-10 py-4 bg-accent text-primary font-bebas text-xl tracking-widest hover:bg-white transition-all duration-500 transform hover:-translate-y-1">
              CHOOSE YOUR CART →
            </a>
            <a href="#menu" className="inline-flex items-center justify-center gap-3 px-10 py-4 border border-white/30 text-white font-bebas text-xl tracking-widest hover:border-accent hover:text-accent hover:bg-accent/5 transition-all duration-500 transform hover:-translate-y-1 backdrop-blur-sm">
              EXPLORE THE MENU ↓
            </a>
          </div>

...
const PACKAGES = [
  {
    ...
    menu: 'BOBA TEA',
    menuJp: 'ボバティー',
    description: 'Start your TAKKERU journey with a signature Boba Tea cart.',
    products: ['boba-tea'],
  ...
  },
  {
    ...
    menu: 'BOBA TEA + MANDU',
    menuJp: 'ボバティー + マンドゥ',
    description: 'Expand your TAKKERU Cart menu with Boba Tea and Mandu.',
  ...
  },
  {
    ...
    description: 'The complete TAKKERU Cart menu combination.',
